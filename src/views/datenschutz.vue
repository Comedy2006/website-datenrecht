    ...
    <article class="legal-page">
        <div class="container-narrow">
            <header class="page-header">
                ...
                <p class="page-lead">
                    Mit dieser Erklärung informieren wir Sie gemäß Art. 13
                    und Art. 14 der Datenschutz-Grundverordnung (DSGVO) sowie § 165 Abs. 3
                    Telekommunikationsgesetz (TKG 2021) über die Verarbeitung Ihrer personenbezogenen Daten
            ...
            <section id="responsible" aria-labelledby="responsible-title">
                <h2 id="responsible-title">1. Verantwortliche Stelle</h2>
                <p>
                ...
                <address class="contact-block">
                    ...
                    Telefon: <a href="tel:+4366412345678">+43 664 1234 5678</a>
                    E-Mail: <a href="mailto:datenschutz@queuecare.at">datenschutz@queuecare.at</a>
                </address>
                <p>
                    Für datenschutzrechtliche Anliegen ist unsere E-Mail-Adresse
                    <a href="mailto:datenschutz@queuecare.at">datenschutz@queuecare.at</a>
                    die schnellste Kontaktmöglichkeit.
                </p>
            </section>

            <section id="general" aria-labelledby="general-title">
                <h2 id="general-title">2. Allgemeine Hinweise</h2>
                <p>
                    Personenbezogene Daten werden ausschließlich auf Grundlage der gesetzlichen
                    Bestimmungen verarbeitet. Diese Erklärung erläutert, welche Daten wir zu welchem
            ...
            <section id="serverlogs" aria-labelledby="serverlogs-title">
                ...
                <p>
                    <strong>Zweck:</strong> Sicherstellung des Betriebs, Fehleranalyse,
                    Abwehr missbräuchlicher Zugriffe.<br />
                    <strong>Rechtsgrundlage:</strong> Art. 6 Abs. 1 lit. f DSGVO.<br />
                    <strong>Speicherdauer:</strong> 7 Tage, danach automatische Löschung.
                </p>
            </section>

            <section id="contact-form" aria-labelledby="contact-form">
                ...
                <p>
                    ...
                    <strong>Speicherdauer:</strong> 6 Monate nach Abschluss der Korrespondenz, sofern keine längere gesetzliche Aufbewahrungspflicht besteht.
                </p>
                <p>
                    Ohne die Pflichtangaben (Name, E-Mail Adresse, Nachricht) können wir Ihre Anfrage nicht beantworten.
                </p>
            </section>
            ...
            <section id="account" aria-labelledby="account-title">
                ...
                <p>
                    <strong>Verarbeitete Daten:</strong> Login-E-Mail, gehasht gespeichertes Passwort, Login-Zeitpunkte, IP-Adresse zum Zeitpunkt des Logins
            ...
            <section id="analytics" aria-labelledby="analytics-title">
                ...
                <p>
                    ...
                    Browser, Betriebssprache.<br />
                    <strong>Zweck:</strong> Reichweitenmessung, Verbesserung der Website auf Basis aggregierter Statistiken.<br />
                    <strong>Rechtsgrundlage:</strong> Art. 6 Abs. 1 lit. a DSGVO (Einwilligung) - die Erfassung erfolgt erst nach Ihrer ausdrücklichen Zustimmung im Cookie-Hinweis.<br />
                    <strong>Speicherdauer:</strong> 14 Monate, danach automatische Löschung.
                </p>
                <p>
                    Sie können der Erfassung jederzeit widersprechen, indem Sie die Cookies in Ihrem Browser löschen oder einen Do-Not-Track-Header aktivieren.
                </p>
            </section>
            ...
            <section id="fonts" aria-labelledby="fonts-title">
                <h2 id="fonts-title">9. Externe Schriftarten (Fonts)</h2>
                <p>
                    Zur einheitlichen Darstellung von Schriftarten setzt diese Website die Schrift <strong>Atkinson Hyperlegible</strong> ein,
                    die wir über den Dienst <strong>Google Fonts</strong> einbinden.
                </p>
                <p>
                    Beim Aufruf unserer Website wird die Schrift vom Server von Google nachgeladen. Dabei wird Ihre IP-Adresse an Google übermittelt.
                </p>
                <p>
                    <strong>Zweck:</strong> Einheitliche und barrierefreie Darstellung von Schriften.<br />
                    <strong>Rechtsgrundlage:</strong> Art. 6 Abs. 1 lit. f DSGVO.<br />
            ...
            <section id="third-countries" aria-labelledby="third-countries-title">
                <h2 id="third-countries-title">11. Übermittlung an Drittländer</h2>
                <p>
                    Eine Übermittlung Ihrer Daten in Länder außerhalb der Europäischen Union (sog. Drittländer) findet grundsätzlich nicht statt.
                    Eine Ausnahme bildet die unter Punkt 9 beschriebene Einbindung von Google Fonts: Hier kann eine Übermittlung an die Server
            ...
            <section id="rights" aria-labelledby="rights-title">
                ...
                <ul>
                    ...
                    <li><strong>Widerruf einer erteilten Einwilligung</strong></li>
                </ul>
                <p>
            ...
            <section id="complaint" aria-labelledby="complaint-title">
                ...
                <address class="contact-block">
                    ...
                    Web: <a href="https://www.dsb.gv.at" rel="noopener">www.dsb.gv.at</a>
                </address>
            </section>
